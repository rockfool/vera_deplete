"""
problem 1J pin 3.1 w/o TF=600/900/1200K
moderator 900 K 
clad      600 K
fuel      600 K
...
fuel_1_or = openmc.ZCylinder(surface_id=101, x0=0, y0=0, r=0.2365, name='Ring 1 OR')
fuel_2_or = openmc.ZCylinder(surface_id=102, x0=0, y0=0, r=0.3344, name='Ring 2 OR')
fuel_3_or = openmc.ZCylinder(surface_id=103, x0=0, y0=0, r=0.4096, name='Ring 3 OR')
...
# Instantiate cells
fuel_1  = openmc.Cell(cell_id=1, name='cell 1')
fuel_2  = openmc.Cell(cell_id=2, name='cell 2')
fuel_3  = openmc.Cell(cell_id=3, name='cell 3')
gap     = openmc.Cell(cell_id=4, name='cell 4')
clad    = openmc.Cell(cell_id=5, name='cell 5')
water   = openmc.Cell(cell_id=6, name='cell 6')


# Use surface half-spaces to define regions
fuel_1.region = -fuel_1_or
fuel_2.region = +fuel_1_or  & -fuel_2_or
fuel_3.region = +fuel_2_or  & -fuel_3_or 
gap.region    = +fuel_3_or & -clad_ir
...
fuel_1.temperature = 1200.0
fuel_2.temperature =  900.0
fuel_3.temperature =  600.0
...
root.add_cells([fuel_1, fuel_2, fuel_3, gap, clad, water])
