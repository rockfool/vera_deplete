...
#time_steps = np.array([0.25, 2.25, 3.75, 6.25,
...
#
assembly_left   = openmc.XPlane(surface_id=21,  x0= 10.7500, name='left')
assembly_right  = openmc.XPlane(surface_id=22,  x0= 10.7500, name='right')
assembly_back   = openmc.YPlane(surface_id=23,  y0=-10.7500, name='back')
assembly_front  = openmc.YPlane(surface_id=24,  y0= 10.7500, name='front')
...
# Instantiate cells
ring1  = openmc.Cell(cell_id=101, name='cell ring 101')
ring2  = openmc.Cell(cell_id=102, name='cell ring 102')
ring3  = openmc.Cell(cell_id=103, name='cell ring 103')
ring4  = openmc.Cell(cell_id=104, name='cell ring 104')
ring5  = openmc.Cell(cell_id=105, name='cell ring 105')
ring6  = openmc.Cell(cell_id=106, name='cell ring 106')
ring7  = openmc.Cell(cell_id=107, name='cell ring 107')
ring8  = openmc.Cell(cell_id=108, name='cell ring 108')
ring9  = openmc.Cell(cell_id=109, name='cell ring 109')
ring10 = openmc.Cell(cell_id=110, name='cell ring 110')
#
...
ring1.region = -fuel_ir1 
ring2.region = +fuel_ir1 & -fuel_ir2
ring3.region = +fuel_ir2 & -fuel_ir3
ring4.region = +fuel_ir3 & -fuel_ir4
ring5.region = +fuel_ir4 & -fuel_ir5
ring6.region = +fuel_ir5 & -fuel_ir6
ring7.region = +fuel_ir6 & -fuel_ir7
ring8.region = +fuel_ir7 & -fuel_ir8
ring9.region = +fuel_ir8 & -fuel_ir9
ring10.region = +fuel_ir9 & -fuel_or
#
#fuel.region = -fuel_or
...
ring1.temperature  = 900.0 
ring2.temperature  = 900.0 
ring3.temperature  = 900.0 
ring4.temperature  = 900.0 
ring5.temperature  = 900.0 
ring6.temperature  = 900.0 
ring7.temperature  = 900.0 
ring8.temperature  = 900.0 
ring9.temperature  = 900.0 
ring10.temperature  = 900.0 
...
root.add_cells([ring1, ring2, ring3, ring4, ring5, ring6, ring7, ring8, ring9, ring10, 
                gap, clad, water])
...
area[ring1] = np.pi * (fuel_ir1.coefficients['r'] ** 2)
area[ring2] = np.pi * (fuel_ir2.coefficients['r'] ** 2 - fuel_ir1.coefficients['r'] ** 2)
area[ring3] = np.pi * (fuel_ir3.coefficients['r'] ** 2 - fuel_ir2.coefficients['r'] ** 2)
area[ring4] = np.pi * (fuel_ir4.coefficients['r'] ** 2 - fuel_ir3.coefficients['r'] ** 2)
area[ring5] = np.pi * (fuel_ir5.coefficients['r'] ** 2 - fuel_ir4.coefficients['r'] ** 2)
area[ring6] = np.pi * (fuel_ir6.coefficients['r'] ** 2 - fuel_ir5.coefficients['r'] ** 2)
area[ring7] = np.pi * (fuel_ir7.coefficients['r'] ** 2 - fuel_ir6.coefficients['r'] ** 2)
area[ring8] = np.pi * (fuel_ir8.coefficients['r'] ** 2 - fuel_ir7.coefficients['r'] ** 2)
area[ring9] = np.pi * (fuel_ir9.coefficients['r'] ** 2 - fuel_ir8.coefficients['r'] ** 2)
area[ring10] = np.pi * (fuel_or.coefficients['r'] ** 2 - fuel_ir9.coefficients['r'] ** 2)

# Set materials volume for depletion. Set to an area for 2D simulations
gad101.volume = area[ring1]
gad102.volume = area[ring2]
gad103.volume = area[ring3]
gad104.volume = area[ring4]
gad105.volume = area[ring5]
gad106.volume = area[ring6]
gad107.volume = area[ring7]
gad108.volume = area[ring8]
gad109.volume = area[ring9]
gad.volume = area[ring10]
