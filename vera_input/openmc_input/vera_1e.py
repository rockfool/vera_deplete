"""
problem 1E IFBA pin 3.1 w/o TF=600K # need to confirm Tf=900 or 600 from manual
moderator 600 K 
clad      600 K
fuel      600 K
...
ifba_or = openmc.ZCylinder(surface_id=201,x0=0, y0=0, r=0.4106, name='IFBA OR')
#
...
ifba_layer  = openmc.Cell(cell_id=5, name='cell 5')
...
fuel.region       = -fuel_or
ifba_layer.region = +fuel_or & -ifba_or
gap.region        = +ifba_or & -clad_ir
clad.region       = +clad_ir & -clad_or
water.region      = +clad_or & +pin_left & -pin_right & +pin_back & -pin_front

# Register materials with Cells
fuel.fill       = fuel_31
ifba_layer.fill = ifba
gap.fill        = helium 
clad.fill       = zirc4
...
root.add_cells([fuel, ifba_layer, gap, clad, water])
