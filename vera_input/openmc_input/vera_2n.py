...
ifba_fuel = openmc.Material(material_id=16, name='UO2 fuel at 3.1% wt enrichment')
ifba_fuel.set_density('atom/b-cm', 6.86463E-02)
ifba_fuel.add_nuclide('U234',6.11864E-06 )
ifba_fuel.add_nuclide('U235',7.18132E-04 )
ifba_fuel.add_nuclide('U236',3.29861E-06 )
ifba_fuel.add_nuclide('U238',2.21546E-02 )
ifba_fuel.add_nuclide('O16' ,4.57642E-02 )
ifba_fuel.depletable = True


materials_file = openmc.Materials([fuel_21, fuel_31, ifba_fuel, fuel_36, fuel_46, helium, water_565, water_600, pyrex, zirc4, gad, ifba, ss304, agincd, b4c, waba])
